...
const Featured = () => {
  ...
  const cardDetails = [
    {
      imageUrl: 'https://s3-alpha-sig.figma.com/img/679b/3cdf/17b8ec542ce1c452944dfb51f10ba010?Expires=1714953600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=nt781G8NHcv0~EQsmHAeYYKzzeqi3JYhuBez6BcnWLI305bnKJcaqrjPZA2dYkIKS8Lg9WlErWDFSDHpaKIvtsqyZInR196ljr9Hf~Klnzp21gs-1wyzb6MW2KRmfFvYFRfrcd9WswxmvE812Xwz0NXNXFlWwu5dpUf1mh7FDUtb8RiqGKrwsetf9j700NgwJ-pw5CPM9X8Ue5pBjyGH8MVlpnP45zq7REZ1X3rVh7Niw5B2KZ0LrHjbPf3RCYu2u5vAHwUJW5xjxvnOH1kjd2t~axl-I0fezM3QNLbqjMJnOp-dCUm4FbjsOvcvrMfkGDWEdcAVo5fQAdv-uiLxFw__',
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col justify-center items-center text-center mb-12">
        <section className="text-sm uppercase mb-2">
          Practice Advice
        </section>
      ...
      <div className="row flex flex-wrap -mx-2">
        {cardDetails.map((card, idx) => (
          <div key={idx} className="content-card flex flex-col w-full md:w-1/3 px-2 mb-4">
            <img src={card.imageUrl} alt="Card visual" className="card-image mb-4 w-full h-auto"/>
            <div className="tags flex space-x-2 mb-2">
              <a href="http://google.com" className="text-xs text-blue-500 hover:text-blue-700">
                Google
              </a>
