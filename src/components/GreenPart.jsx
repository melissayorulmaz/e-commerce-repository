...
const Carousel = () => {
  ...
  return (
    <div className="relative bg-teal-900 h-100 w-full">
      <div className="flex justify-center items-center h-full w-full">
        ...
        <img src={slideImageURL} alt="Slide" className="flex-1 max-w-lg h-full w-full object-fit contain object-position left bottom" />
      </div>
